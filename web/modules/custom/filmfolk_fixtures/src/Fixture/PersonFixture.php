    ...
    $this->createPerson([
      ...
      'field_person_funktion_erfaring' => [
            [
              ...
              FunktionErfaringItem::PROPERTY_ERFARING_TARGET_ID => $this->getReference('erfaring:Nogen erfaring (5-10 produktioner)')->id(),
            ],
            [
              FunktionErfaringItem::PROPERTY_FUNKTION_TARGET_ID => $this->getReference('funktion:Animator')->id(),
              FunktionErfaringItem::PROPERTY_ERFARING_TARGET_ID => $this->getReference('erfaring:Lidt erfaring (1-4 produktioner)')->id(),
            ],
      ],
      'field_person_title' => [
